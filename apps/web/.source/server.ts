// @ts-nocheck
import * as __fd_glob_25 from "../content/docs/window-management/scratchpad.mdx?collection=docs"
import * as __fd_glob_24 from "../content/docs/window-management/rules.mdx?collection=docs"
import * as __fd_glob_23 from "../content/docs/window-management/overview.mdx?collection=docs"
import * as __fd_glob_22 from "../content/docs/window-management/layouts.mdx?collection=docs"
import * as __fd_glob_21 from "../content/docs/visuals/theming.mdx?collection=docs"
import * as __fd_glob_20 from "../content/docs/visuals/status-bar.mdx?collection=docs"
import * as __fd_glob_19 from "../content/docs/visuals/effects.mdx?collection=docs"
import * as __fd_glob_18 from "../content/docs/visuals/animations.mdx?collection=docs"
import * as __fd_glob_17 from "../content/docs/scripting/ipc.mdx?collection=docs"
import * as __fd_glob_16 from "../content/docs/configuration/monitors.mdx?collection=docs"
import * as __fd_glob_15 from "../content/docs/configuration/miscellaneous.mdx?collection=docs"
